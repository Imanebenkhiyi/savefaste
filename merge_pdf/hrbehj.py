...
@app.route('/')
def home():
    return redirect(url_for('serve_merge_html'))

@app.route('/mergepdf')
def serve_merge_html():
    # عرض ملف mergepdf.html من مجلد templates
...
def progress():
    ...
    download_link = f"/download/{session_id}.pdf"
    return f"""
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="container">
    ...
    <div class="file-info">
      <p><strong>📄 File Name:</strong> merged_{session_id}.pdf</p>
