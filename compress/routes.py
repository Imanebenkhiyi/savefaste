...
def progress():
    ...
    download_link = url_for('compress.download_compressed', filename=filename)

    return render_template(
        'compress_progress.html',
...
@compress_bp.route('/delete/<filename>', methods=['DELETE'])
